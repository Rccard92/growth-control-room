...
- **Product & Collection SEO Optimizer**: score trasparente con breakdown, SEO skill pack interno (`gcr-shopify-seo`) ispirato/adattato da [claude-seo](https://github.com/AgriciDaniel/claude-seo) (MIT), drawer Modifica con proposta manuale/AI, preview, approve/apply controllato (no blog/editorial in v1)
