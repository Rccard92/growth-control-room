...
def _build_registry() -> dict[str, AiOperationDefinition]:
    ops: list[AiOperationDefinition] = [
        ...
        _op(
            ...
            status="planned",
            enabled=False,
            recommended_use="Premium per strategia avanzata.",
        ),
        _op(
            "ped_calendar_generation",
            "Calendario PED",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per calendario editoriale.",
        ),
        _op(
            "ped_post_copy",
            "Copy post PED",
            ...
            status="planned",
            enabled=False,
            recommended_use="Cheap per copy breve social.",
        ),
        _op(
            "ped_creative_prompt",
            "Prompt creativo PED",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per prompt creativi.",
        ),
        _op(
            "ped_image_prompt",
            "Prompt immagine PED",
            ...
            status="planned",
            enabled=False,
            recommended_use="Cheap per prompt immagine breve.",
        ),
        _op(
            "social_comment_response",
            "Risposta commento social",
            "social",
            "generate_response",
            "social_response",
            "cheap",
            ...
            status="planned",
            enabled=False,
            recommended_use="Cheap per risposte brevi.",
        ),
        # SEO futuri
        _op(
            "seo_keyword_research",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per ricerca keyword.",
        ),
        _op(
            "seo_content_gap_analysis",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per gap analysis.",
        ),
        _op(
            "seo_article_outline",
            "Outline articolo SEO",
            "content_seo",
            "article_outline",
            "blog_brief",
            "standard",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per outline.",
        ),
        _op(
            "seo_article_generation",
            "Articolo SEO",
            ...
            status="planned",
            enabled=False,
            recommended_use="Premium per articoli SEO lunghi.",
        ),
        _op(
            "seo_article_optimization",
            "Ottimizzazione articolo SEO",
            "content_seo",
            "optimize_article",
            "article_draft",
            "standard",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per ottimizzazione.",
        ),
        ...
        _op(
            ...
            status="planned",
            enabled=False,
            recommended_use="Premium per strategia campagna complessa.",
        ),
        _op(
            "email_copy_generation",
            "Copy email",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per email marketing.",
        ),
        _op(
            "ads_copy_generation",
            "Copy ads",
            ...
            status="planned",
            enabled=False,
            recommended_use="Standard per varianti ads.",
        ),
        _op(
            "landing_copy_generation",
            "Copy landing",
            ...
            status="planned",
            enabled=False,
            recommended_use="Premium per landing lunghe.",
        ),
    ]
