...
interface SeoEntityEditPanelProps {
  projectId: string;
...
export function SeoEntityEditPanel({
  embedded = false,
  open = true,
  onClose,
  projectId,
  ...
  }, [open, embedded, entityKey, detail, formDirty, initFormFromDetail]);
  ...
  const footer = (
    <SeoProposalFooter
      ...
      onCancel={embedded ? handleClose : handleClose}
    />
  );
  ...
  const editorBody = (
    <>
      ...
      {!detailLoading && detail && (
        <>
          {embedded && (
            <div className="seo-entity-edit-panel__embedded-toolbar">
              {headerExtra}
              <div className="seo-entity-edit-panel__embedded-actions">{headerActions}</div>
              {headerStatus}
            </div>
          )}
          ...
          {embedded && appliedAt && (
            <p className="seo-entity-edit-panel__rescan-hint">
              Dopo aver applicato le modifiche, usa &quot;Riscansiona pagina&quot; per aggiornare lo
              score tecnico.
            </p>
          )}
  ...
  if (embedded) {
    return (
      <div className="seo-entity-edit-panel seo-entity-edit-panel--embedded">
        {editorBody}
        {!detailLoading && detail && footer}
      </div>
    );
  }
